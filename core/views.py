...
def barbeiros(request):
    ...
    return render(request, 'core/barbeiros.html', {'lista_barbeiros': lista})
...
def adicionar_barbeiro(request):
    ...
    if nome:
        ...
        if criado and era_primeiro:
            # Migra todos os registros sem barbeiro para este
...
def servicos(request):
    ...
    return render(request, 'core/servicos.html', {'lista_servicos': lista})
...
def produtos_view(request):
    ...
    return render(request, 'core/produtos.html', {'lista_produtos': lista})
